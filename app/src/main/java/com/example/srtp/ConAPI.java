...
public class ConAPI {
    private static String serverURL = "http://yourseverurl";
    ...
    public static String testGet()throws Exception{
        ...
        System.out.println("enter testGet API" + URL);
    ...
    public static String postPaths(String cloth, String photo) throws Exception{
        String URL = serverURL + "/write/";
        String data = "figure=" + URLEncoder.encode(photo, "UTF-8") +
                "&cloth=" + URLEncoder.encode(cloth, "UTF-8");
        return MyHTTP.postJson(URL,data);
    }
    ...
    public static String getAllClothes() throws Exception{
        String URL = serverURL + "/clothes/";
        return MyHTTP.getJson(URL);
    }

    public static byte[] getCloth(String filename) throws Exception{
        String URL = serverURL + "/clothes/" + filename;
        return MyHTTP.getImage(URL);
    }

    public static byte[] getTryOn(String filename) throws Exception{
        String URL = serverURL + "/tryons/" + filename;
        return MyHTTP.getImage(URL);
    }
