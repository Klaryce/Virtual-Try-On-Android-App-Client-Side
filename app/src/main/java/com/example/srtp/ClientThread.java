...
public class ClientThread implements Runnable {
    ...
    private static final String SOCKET_IP = "socketurl";
    private static final int SOCKET_PORT = 8443; //8888
    // 以下是HTTP接口调用的服务地址，根据实际情况修改IP和端口
    public static final String REQUEST_URL = "http://yourserverurl/upload";
